# Диаграмма классов
![](https://github.com/Marina200426/PIS-Belonogov-Chelokhsaeva/blob/main/Диаграмма%20классов/Новая_диаграмма.png)
...
Агрегация – Контроллер вызывает сервис пользователя для обновления данных.
- AuthController → AuthService\
Агрегация – Контроллер использует сервис для выполнения логики входа, выхода и регистрации.
...
### Модели → Модели
- Application → User\
Ассоциация – Заявка ссылается на пользователя, который её подал.
- Application → Service\
Ассоциация – Заявка ссылается на услугу, на которую она подана.
...
- User → Characteristic\
Ассоциация – Пользователь связан со списком своих характеристик.
- Characteristic → CharacteristicType\
Ассоциация – Характеристика указывает на свой тип.
- Service → Rule\
Ассоциация – Услуга связана с набором правил, определяющих её условия.
- Rule → CharacteristicType\
Ассоциация – Правило использует тип характеристики для логики (валидации/ограничений).
- Service → User\
Ассоциация – Услуга ассоциирована с ответственным пользователем (например, сотрудником госоргана).
