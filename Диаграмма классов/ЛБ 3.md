# Диаграмма классов
![](https://github.com/Marina200426/PIS-Belonogov-Chelokhsaeva/blob/main/Диаграмма%20классов/Диаграмма_классов_3.png)
...
### Сервисы → Модели
- ServiceService  → Rule\
Ассоциация – Сервис взаимодействует с правилами при определении условий предоставления услуг,атакже при изменении правил.
- ServiceService  → Service\
Ассоциация – Сервис выполняет операции с сущностями услуг, такими как создание, обновление и удаление.
- ApplicationService  → Application\
Ассоциация – Сервис обрабатывает заявки, создаёт, отменяет и получает заявки пользователей.
- ApplicationService → ApplicationStatus\
Ассоциация – Сервис изменяет статус заявки, используя перечисление возможных состояний.
- AuthService  → User\
Ассоциация – Сервис управления пользователями обновляет и обрабатывает информацию о профиле для регистрации пользователя.
- UserService  → User\
Ассоциация – Сервис управляет данными пользователя и обеспечивает доступ к ним для обновления .
